...
public class InvoiceAppStack extends Stack {
    ...
    public InvoiceAppStack(final Construct scope, final String id, final StackProps props) {
        ...
        bucket = Bucket.Builder.create(this, "S301")
                .bucketName("aws-cdk-udemy-course-invoice")
                .removalPolicy(RemovalPolicy.DESTROY)
                .build();

        // EventType.OBJECT_CREATED_PUT limits the event to only PUT events
        ...
        SqsSubscription sqsSubscription = SqsSubscription.Builder.create(s3InvoiceQueue)
                .build();
